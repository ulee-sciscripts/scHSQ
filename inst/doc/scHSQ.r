...
###################################################
### code chunk number 1: scHSQ.Rnw:52-54
###################################################
library(Biobase)
library(monocle3)
library(ggplot2)
...
###################################################
### code chunk number 2: scHSQ.Rnw:59-60
###################################################
library(scHSQ)
data(testis_3sp)
...
###################################################
### code chunk number 3: scHSQ.Rnw:68-68
###################################################
dros_testis <- new_scHSQ(testis_3sp, "mel", "spec", "known_type")


###################################################
### code chunk number 4: scHSQ.Rnw:79-80
###################################################
...
###################################################
### code chunk number 5: scHSQ.Rnw:86-86
###################################################
plotANOVA(dros_testis)


###################################################
### code chunk number 6: scHSQ.Rnw:98-101
###################################################
...
###################################################
### code chunk number 7: scHSQ.Rnw:124-130
###################################################
...
###################################################
### code chunk number 8: scHSQ.Rnw:146-146
###################################################
