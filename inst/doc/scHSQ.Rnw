...
The resulting object is called ``LeeEtAl". We thus use the known labels to generate a new \Rpackage{scHSQ} object as following:

<<>>=
dros_testis <- new_scHSQ(LeeEtAl, "mel", "spec", "known_type")
@
